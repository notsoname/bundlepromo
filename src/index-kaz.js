...
recomendationBtns.forEach((rec) => {
  ...
  <div class="popup-wrapper">
      <div class="popup-itemCard">
          ...
          <div class="popup-itemCard-color"><b>Түс</b>: сұр</div>
...
popup.addEventListener("click", (e) => {
  ...
  if (e.target.className == "btn btn-black popup-itemCard-buy") {
    ...
    $.ajax("https://shop.samsung.com/kz_kz/ng/p4v1/addToCart", {
        cache: false,
        crossDomain: true,
        ...
        //   _thisBtn.removeClass("cta--disabled");
          location.href = "https://shop.samsung.com/kz_kz/cart";
        },
...
let SeceProductList = {
  searchApiURL:
    "https://searchapi.samsung.com/v6/front/b2c/product/card/detail/newhybris?siteCode=kz_kz&shopSiteCode=kz_kz&commonCodeYN=N&saleSkuYN=N&onlyRequestSkuYN=N&keySummaryYN=N&modelList=",
  mySwiper: [],
  productsReady: [],
  ...
  omniVar: "kz_kz:offer:may-bundle-promo:",
  productCombos: [],
  giftsParsed: [],
  giftInStock: [],
  init: function () {
          ...
          if (Object.keys(chipsList).length > 0) {
            ...
            $.each(chipsList, function (key, value) {
              ...
              if (key == "COLOR") {
                chipsHtml =
                  chipsHtml +
                  '<p class="color-label" data-font-size-pc="14" data-font-size-mo="24">Түс: <span>' +
...
packListFinal["#pack-10"] = [
  { product: "LS27A800NMIXCI", 
    ...
    gift: {
      title:
        "<b>Сіздің алатыныңыз:</b><br> Galaxy A33, шаңсорғыш және келесі жолы тауар сатып алуға -10% бен 100000 тг промокодтар",
...
packListFinal["#pack-11"] = [
  { product: "AR12BSFCMWKNER", 
    ...
    gift: {
      title:
        "<b>Сіздің алатыныңыз:</b><br> шаңсорғыш пен келесі жолы тауар сатып алуға -10% промокод",
